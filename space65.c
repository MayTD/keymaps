...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_CAPS, KC_LALT, KC_LGUI,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RGUI, KC_RALT,                   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_DEL,  KC_DEL,  KC_TRNS,
      KC_CAPS,          RGB_TOG, RGB_MOD, KC_TRNS, KC_F13,  KC_F14,  KC_F24,  KC_TRNS, KC_PSCR, KC_SCRL, KC_PAUSE, KC_UP,    KC_TRNS, KC_TRNS, KC_TRNS,
      KC_TRNS,          KC_VOLD, KC_VOLU, KC_MUTE, KC_EJCT, KC_TRNS, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT, KC_TRNS,          KC_TRNS,
      KC_TRNS, KC_TRNS, RGB_HUI, RGB_HUI, RGB_VAI, KC_TRNS, KC_TRNS, KC_PPLS, KC_PMNS, KC_END,  KC_PGDN, KC_DOWN, KC_TRNS,           KC_TRNS, KC_TRNS,
